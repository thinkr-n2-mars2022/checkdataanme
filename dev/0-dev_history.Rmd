...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "First Fusen Full Package",
    Description = "Create a package following the exercice description on slide 372",
    `Authors@R` = c(
      person("Aurélien", "Macé", email = "aurelien.mace@finddx.org", role = c("aut", "cre")),
      person(given = "FIND", role = "cph")
    )
  )
)
# Define License with use_*_license()
usethis::use_proprietary_license("FIND")
```
